    ...
    public string GetBindingText(Binding binding)
    {
        switch (binding)
        {
            ...
            case Binding.Gamepad_Interact:
                return _characterInputAction.Player.Interact.bindings[1].ToDisplayString();
            case Binding.Gamepad_InteractAlternate:
                return _characterInputAction.Player.InteractAlternate.bindings[1].ToDisplayString();
            case Binding.Gamepad_Pause:
                return _characterInputAction.Player.Pause.bindings[1].ToDisplayString();
        }
    }
